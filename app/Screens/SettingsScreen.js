...
const styles = StyleSheet.create({
  ...
  pillBtnText: { color: '#fff', fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', fontSize: 16, textTransform: 'uppercase', letterSpacing: 0.5 },
  ...
  input: { backgroundColor: 'transparent', borderRadius: 14, paddingHorizontal: 14, paddingVertical: 11, fontSize: 16, fontFamily: 'serif', fontWeight: '700', color: '#000', borderWidth: 1.5, borderColor: COLORS.pinkBorder },
