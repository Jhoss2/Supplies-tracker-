...
const styles = StyleSheet.create({
  ...
  profileName: { color: COLORS.white, fontSize: 15, fontWeight: '900', fontStyle: 'italic', textTransform: 'uppercase', textAlign: 'center' },
  profileLastName: { color: COLORS.grayMid, fontSize: 16, fontWeight: '700', textTransform: 'uppercase', textAlign: 'center' },
  profileFiliere: { color: '#6B7280', fontSize: 15, fontStyle: 'italic', textAlign: 'center', marginTop: 2 },
  ...
  infoLabel: { fontSize: 15, fontWeight: '800', color: COLORS.grayMid, textTransform: 'uppercase' },
  infoValue: { fontSize: 15, fontWeight: '700', color: COLORS.black, fontStyle: 'italic' },
  sectionTitle: {
    fontSize: 15,
    fontWeight: '900',
    fontStyle: 'italic',
