...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', color: COLORS.navyBlue, fontSize: 13, textTransform: 'uppercase', marginBottom: 8, letterSpacing: 0.5 },
  ...
  cardHint: { fontFamily: 'serif', fontWeight: '700', fontStyle: 'italic', color: COLORS.grayMid, fontSize: 12, textTransform: 'uppercase' },
  ...
  idHint: { fontFamily: 'serif', fontStyle: 'italic', color: COLORS.grayMid, fontSize: 10, textTransform: 'uppercase', textAlign: 'center', paddingHorizontal: 8 },
  galleryLink: { fontFamily: 'serif', fontWeight: '700', fontStyle: 'italic', color: COLORS.navyBlue, fontSize: 11, marginTop: 6, textDecorationLine: 'underline' },
...
const camStyles = StyleSheet.create({
  ...
  hint: { color: '#fff', fontFamily: 'serif', fontWeight: '800', fontSize: 14, backgroundColor: 'rgba(0,0,0,0.5)', padding: 10, borderRadius: 10, marginBottom: 20, textAlign: 'center' },
  ...
  btnText: { color: '#fff', fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', fontSize: 14, textTransform: 'uppercase' },
});
