...
const styles = StyleSheet.create({
  ...
  userName: { color: COLORS.navyBlue, fontSize: 12, fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', textTransform: 'uppercase', textAlign: 'center' },
  userLastName: { color: COLORS.grayMid, fontSize: 10, fontFamily: 'serif', fontWeight: '700', textTransform: 'uppercase', textAlign: 'center' },
  empty: { alignItems: 'center', marginTop: 60 },
  emptyText: { fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', color: COLORS.navyBlue, fontSize: 16 },
  emptySubText: { color: COLORS.grayMid, fontSize: 13, marginTop: 8, fontFamily: 'serif', fontStyle: 'italic' },
  fab: {
  ...
  passInput: { width: '100%', backgroundColor: COLORS.pinkBg, color: '#000', borderRadius: 14, padding: 12, fontSize: 14, fontFamily: 'serif', fontWeight: '700', marginBottom: 16, borderWidth: 1.5, borderColor: COLORS.pinkBorder },
