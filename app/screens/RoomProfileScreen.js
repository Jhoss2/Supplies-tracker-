...
const styles = StyleSheet.create({
  ...
  occupiedText: { color: '#fff', fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', fontSize: 13, textAlign: 'center', textTransform: 'uppercase' },
  ...
  passInput: { width: '100%', backgroundColor: COLORS.pinkBg, color: '#000', borderRadius: 14, padding: 12, fontSize: 14, fontFamily: 'serif', fontWeight: '700', borderWidth: 1.5, borderColor: COLORS.pinkBorder },
