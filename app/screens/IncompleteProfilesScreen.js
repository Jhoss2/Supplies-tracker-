...
const styles = StyleSheet.create({
  ...
  count: { textAlign: 'center', fontFamily: 'serif', fontWeight: '800', fontStyle: 'italic', color: COLORS.navyBlue, fontSize: 14, marginBottom: 10 },
  ...
  filiere: { fontFamily: 'serif', fontStyle: 'italic', color: COLORS.grayMid, fontSize: 12, marginBottom: 6 },
