// app/database/db.js — expo-sqlite ~15.1.4
...
export const initDatabase = async () => {
  try {
    ...
    // Migration : ajouter id_photo si absent
    try {
    ...
    // Seed salles
    const roomNames = [
      'TOUR DU SAVOIR','TOGUYENI','SALLE 15','SALLE 05','SALLE 04',
      'SALLE 06','SALLE 07','SALLE 16','SALLE 17','SALLE 18','SALLE 19',
      'SALLE 21','SALLE 22','SALLE 23','SALLE 26','SALLE 27',
      'LAB B ROOM 3','LAB ROOM 1','LAB ROOM 2','LAB ROOM 3',
      'AMPHI R.1','AMPHI R.2.A','AMPHI R.2.B','AMPHI R.2.C',
      'AMPHI R.2.D','AMPHI R.4','AMPHI R.0'
    ];
